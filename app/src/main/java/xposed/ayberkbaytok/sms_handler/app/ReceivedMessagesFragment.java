...
public class ReceivedMessagesFragment extends MainFragment implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mRecyclerView = (ListRecyclerView)view.findViewById(R.id.received_messages_recyclerview);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new ReceivedMessageAdapter(this);
        ...
        disableFab();
        setTitle(R.string.received_messages);
        onNewArguments(getArguments());
        ReceivedMessageLoader.get().markAllSeen(getContext());
    }
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
        ...
        inflater.inflate(R.menu.context_received_messages, menu);
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        inflater.inflate(R.menu.options_received_messages, menu);
        if (DEBUG_MODE) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_item_sent_messages:
                createTestSms();
                return true;
            case R.id.menu_item_clear_received:
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        return new CursorLoader(getContext(),
                DatabaseContract.ReceivedMessages.CONTENT_URI,
                DatabaseContract.ReceivedMessages.ALL, null, null,
                DatabaseContract.ReceivedMessages.TIME_SENT + " DESC");
    }
    ...
    private void clearAllMessages() {
        ...
        ReceivedMessageLoader.get().deleteAll(context);
    ...
    private void showMessageDetailsDialog(Uri uri) {
        Context context = getContext();
        SmsMessageData messageData = ReceivedMessageLoader.get().query(context, uri);
        if (messageData != null) {
    ...
    public void showMessageDetailsDialog(final SmsMessageData messageData) {
        ...
        ReceivedMessageLoader.get().setReadStatus(context, messageData.getId(), true);
    }
    ...
    private void restoreSms(long smsId) {
        ...
        final SmsMessageData messageData = ReceivedMessageLoader.get().query(context, smsId);
        if (messageData == null) {
        ...
        ReceivedMessageLoader.get().delete(context, smsId);
        ...
        showSnackbar(R.string.message_restored, R.string.undo, new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ReceivedMessageLoader.get().insert(context2, messageData);
    ...
    private void deleteSms(long smsId) {
        ...
        final SmsMessageData messageData = ReceivedMessageLoader.get().queryAndDelete(context, smsId);
        if (messageData == null) {
