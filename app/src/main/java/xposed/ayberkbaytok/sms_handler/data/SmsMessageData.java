package xposed.ayberkbaytok.sms_handler.data;
...
import xposed.ayberkbaytok.sms_handler.utils.SmsMessageUtils;
...
public class SmsMessageData {
    ...
    public Uri getUri() {
        ...
        return ContentUris.withAppendedId(DatabaseContract.ReceivedMessages.CONTENT_URI, id);
    }
}
